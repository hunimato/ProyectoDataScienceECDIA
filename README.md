...
- 🏷️ Categorización manual de productos en **25+ categorías** (reduciendo "Otros" a < 5%)
...
- ⚠️ Enfoque exploratorio y predictivo — sin prescripción de políticas
...
**Lo más destacado:**
- ⚙️ Feature engineering: `dias_espera`, `faltas_previas`, `turnos_previos`
...
**Hugo Martínez Tornaria**
- 30 años de experiencia en nutrición clínica y telemedicina
- Docente universitario con 25 años de trayectoria
- Especialización en Ciencia de Datos e IA — UTEC / ECDIA

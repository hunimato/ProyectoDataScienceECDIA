...
Original file is located at
    https://colab.research.google.com/drive/1zi93viIxaCBPbJCbuOAN4s0sFm_dP8dB
...
### <center>Hugo Martinez - Jeasmine Nahui -  Leticia Colombo - Valentina Ghan</center>

# **Etapa I: Problemática y conjunto de datos**

### Definición y contextualización de la Problemática

El conjunto de datos empleado en este proyecto fue obtenido de la plataforma [Kaggle](https://www.kaggle.com/datasets/aslanahmedov/market-basket-analysis/data?select=Assignment-1_Data.csv). Contiene información detallada sobre transacciones realizadas por un minorista en el período comprendido entre el 1.º de diciembre de 2010 a las 08:26:00 y el 9 de diciembre de 2011 a las 12:50:00, siendo la resolución temporal mínima disponible la hora y el minuto de cada transacción. Es importante notar que diciembre de 2011 está incompleto, ya que solo incluye transacciones hasta el día 9, lo cual deberá considerarse al realizar análisis anuales. Cabe destacar que no se dispone de información exacta sobre qué minorista son los respectivos datos; de igual forma, dado que disponemos del país donde se ha realizado la transacción, asumimos que el estudio va a estar principalmente enfocado a un minorista en el Reino Unido.

**Contenido del Dataset:**

El archivo proporcionado se llama Assignment-1_Data y contiene los siguientes atributos:
  * BillNo: Número de factura (6 dígitos) asignado a cada transacción. (Tipo: object)
  * Itemname: Nombre del producto. (Tipo: object)
  * Quantity: Cantidad de cada producto por transacción. (Tipo: int64)
  * Date: Fecha y hora en que se generó la transacción. (Tipo: object)
  * Price: Precio del producto. (Tipo: object)
  * CustomerID: Número único (5 dígitos) asignado a cada cliente. (Tipo: float64)
  * Country: País donde reside cada cliente. (Tipo: object)
...
**Características del Dataset:**
  ...
  * Número de filas: 522,065
  * Número de columnas: 7


**Motivación / Objetivo:**

La eleccion fue con el fin de investigar patrones de comportamiento de compra en el contexto de un comercio minorista, centrándonos en el análisis de tendencias, estacionalidades y relaciones entre productos.

A través de un análisis exploratorio, se busca comprender la estructura y calidad de los datos, identificar posibles anomalías y preparar la información para futuras fases de análisis.

Se visualizan dos enfoques complementarios:

Análisis de Canasta de Mercado (Market Basket Analysis): Para descubrir combinaciones frecuentes de productos adquiridos conjuntamente, lo cual puede ofrecer insights útiles para estrategias comerciales como promociones cruzadas u ofertas personalizadas.

Análisis de tendencias y estacionalidades de compra, segmentadas por país y por momento del año o del mes, con el fin de identificar patrones de consumo recurrentes o particulares.

### Preguntas claves

**Preguntas sobre el análisis preliminar:**

1. Productos más vendidos: ¿Cuáles son los productos más comprados en general?

2. Patrones por país: ¿Varían los productos más frecuentes según el país o la región?

3. Temporalidad en la compra de productos: ¿Qué productos se compran más en ciertas épocas del año o días de la semana?

4. Ticket promedio: ¿Cuál es el gasto promedio por transacción?

5. Distribución de precios: ¿Qué rangos de precios predominan en las compras?

6. Relación cantidad-precio: ¿Cómo varía la cantidad comprada dependiendo del precio del producto?

7. Clientes recurrentes: ¿Con qué frecuencia compran? ¿Qué porcentaje de clientes realiza compras repetidas y con qué frecuencia?

8. Categorías de productos: Si los productos están categorizados, ¿qué categorías generan más ventas? En caso contrario, podemos categorizarlos?

La confirmación de estas preguntas, puede mostrar patrones que impliquen oportunidades para mejorar la gestión de inventarios, planificar promociones más efectivas y personalizar ofertas según segmentos específicos de clientes, aumentando así la rentabilidad y fidelización.

## Funciones e Imports

A continuación agrupamos todas los imports necesarios y las funciones creadas a lo largo del trabajo, independiente de la etapa que se quiera ejecutar, recomendamos ejecutar esta parte
"""
...
!jupyter nbconvert --to html '/content/drive/MyDrive/Colab Notebooks/Grupo 3.ipynb'